export function getClient(clientId) {
  const clients = {
    "610-marketing": {
      ...
      nameSlug: "610-marketing",
      seoDescriptor: "digital-marketing-and-AI-consulting-agency-near-me",
      gmbLocations: [
        { id: "san-diego", city: "San Diego", state: "CA", gmbLocationId: null },
        { id: "houston", city: "Houston", state: "TX", gmbLocationId: null },
        { id: "mcallen", city: "McAllen", state: "TX", gmbLocationId: null },
        { id: "austin", city: "Austin", state: "TX", gmbLocationId: null },
        { id: "stafford", city: "Stafford", state: "VA", gmbLocationId: null },
      ],
      nameSlug: "610-marketing",
      seoDescriptor: "digital-marketing-and-AI-consulting-agency-near-me",
      gmbLocations: [
...
// Generate SEO-optimized filename for images
// Format: {primary_topic}_{client_slug}_{seo_descriptor}_{number}.{ext}
export function getSeoFilename(primaryTopic, clientId, number, ext = "jpg") {
  const client = getClient(clientId) || { seoDescriptor: "digital-marketing", nameSlug: "610-marketing" };
  const descriptor = client.seoDescriptor || "digital-marketing-and-AI-consulting-agency-near-me";
  const nameSlug = client.nameSlug || clientId;
  ...
  return `${topicSlug}_${nameSlug}_${descriptor}_${number}.${ext}`;
}
