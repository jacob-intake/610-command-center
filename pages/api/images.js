...
const VISUAL_STYLE_LIBRARY = {
  "Nike Energy": {
    brief: "Single subject or minimal scene with dominant negative space. Real unposed human moment, never staged or performative. Subject caught at a threshold, a moment of decision, hesitation, or quiet determination before action. Wide cinematic framing that makes the subject feel small against something larger than themselves. Natural existing light, no studio feel. Muted or desaturated color palette with one strong tonal anchor, deep sky blue, cool concrete grey, or dark near-black. High contrast between subject and background. No clutter, no props unless essential to the moment. Composition breathes. Shot on 24mm to 35mm wide lens, f/5.6 to f/8, everything sharp, no shallow depth of field tricks. Feels like it was captured not constructed. The image suggests a feeling rather than explains it.",
    override: true, // When true, replaces the default brief entirely
  },
  "Authoritative": {
